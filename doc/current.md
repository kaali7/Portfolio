...
- **Netran AI Demo Media & Visuals (`lib/projectsDetailData.ts`)**: Configured high-resolution Netran AI UI screenshots (`netrain_dashbaord_page.png`, `netrain_audio_recode_interview.png`, `netrain_evalution_proces.png`, `netrain_report_page.png`, `netrain_analytics_page.png`, `netrain_history_page.png`), linked muted demo video (`/projects/video/netrain.mp4`), and enhanced the dynamic Case Study template (`app/work/[id]/page.tsx`) with an interactive Video/Image tab switcher and Lightbox modal.
- **Git Branch**: `main`.
