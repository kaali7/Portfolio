...
const iconMap: Record<string, SimpleIcon> = {
  ...
  // Backend & APIs
  "FastAPI": siFastapi,
  "FastAPI WebSocket Gateway": siFastapi,
  "Flask": siFlask,
  "Flask-CORS": siFlask,
  ...
  "Ollama": siOllama,
  "Ollama Daemon": siOllama,
  "Ollama Qwen 2.5": siOllama,
  "Ollama Qwen 2.5 (3B)": siOllama,
  "qwen2.5:3b": siOllama,
  "qwen2.5:3b (Ollama)": siOllama,
...
const componentMap: Record<string, React.ElementType> = {
  ...
  "Speaker Verification & Voice Print Enrollment": UserCheck,
  ...
  "Multimodal 3-Branch Evaluation Engine": Layers,
  "Full-Duplex Voice-to-Voice Pipeline": Workflow,
  "Deterministic Turn-Taking State Machine": Workflow,
  "Acoustic Echo Cancellation & Pre-Roll Gating": ShieldCheck,
  "Hybrid Turn-Taking Classification": Workflow,
  "Web Audio API": Radio,
  "AudioWorklet": Radio,
  "Web Audio Worklet Transport": Radio,
  "Input-Hash Deduplication": Binary,
  "SHA-256 Input-Hash Cache Deduplication": Binary,
  "Keyword Density Scoring & Question Trees": Binary,
  "Web Search Augmentation": Search,
  "Web Search-Augmented Market Intelligence": Search,
