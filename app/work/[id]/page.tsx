...
import { ArrowLeft, Check, Sparkles, Terminal, Code2 } from "lucide-react";

// Design Read:
// Reading this as: High-contrast editorial theme reversal for /work/[id],
// matching /work and /about with a pure white background (bg-white),
// black headings (text-[#08080A]) and rich purple accents (text-purple-600, bg-purple-600).
...
export default function ProjectDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <main className="w-full min-h-screen bg-white text-[#08080A] selection:bg-purple-600 selection:text-white pb-20 relative overflow-hidden">
      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200/80">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-5 flex items-center justify-between">
          <Link 
            href="/work" 
            className="inline-flex items-center gap-2 text-xs sm:text-sm font-mono font-bold text-slate-700 hover:text-purple-600 px-4 py-2 rounded-full bg-slate-50 hover:bg-white border border-slate-200 transition-all cursor-pointer shadow-2xs"
          >
          ...
          <div className="flex items-center gap-3">
            <span className="text-xs font-mono font-bold text-purple-700 bg-purple-100 border border-purple-300 px-3 py-1 rounded-full uppercase">
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-8">
        <div className="bg-[#08080A] text-white border border-purple-500/40 rounded-3xl p-6 sm:p-8 overflow-hidden shadow-2xl">
          ...
          <div className="flex items-center justify-between pb-4 mb-4 border-b border-white/10">
            ...
            <span className="text-xs font-mono text-slate-400">PYTHON / C++ CODE MODULE</span>
          </div>
      ...
      <footer className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 pt-12 mt-12 border-t border-slate-200/80 flex items-center justify-between">
        {prevProject ? (
          <Link 
